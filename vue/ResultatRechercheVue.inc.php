...
<table>
<tr><th><?=$rechercheArtiste?></th><th><?=$rechercheAlbum?></th><th><?=$recherchePiece?></th></tr>
<?php 
	...
	foreach($tableauTrouves as $elementTrouve){
		...
		foreach($albums as $album){
			...
			//écrit une entrée de tableau si le tsitre ou l'artiste de l'album correspond à l'expression recherchée
