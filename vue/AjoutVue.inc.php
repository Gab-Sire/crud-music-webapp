	...
	if(isset($_POST["submit"])) {
		...
		if(isset($_POST['titreAlbum'])){
			...
			if(strlen(trim($titreAlbum)) < 1 || strlen($titreAlbum) > 40){
				//echo "Le titre de l'album est plus de 40 caract�res ou vide <br />";
		...
		if(isset($_POST['artiste'])){
			...
			if(strlen(trim($artiste)) < 1 || strlen($artiste) > 40){
				//echo "Le nom de l'artiste de l'album est plus de 40 caract�res ou vide <br />";
		...
		// Validation avec les pieces musicales � suivre...
